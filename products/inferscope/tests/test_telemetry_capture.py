...
def _make_dynamo_scrape() -> ScrapeResult:
    return ScrapeResult(
        ...
        raw_metrics={
            ...
            "dynamo_component_gpu_cache_usage_percent": 0.82,
            "dynamo_component_gpu_prefix_cache_hit_rate": 0.71,
            "dynamo_component_active_blocks": 820.0,
            "dynamo_component_total_blocks": 1000.0,
        },
        samples=[
            MetricSample(name="dynamo_frontend_inflight_requests", labels={}, value=3.0),
            MetricSample(name="dynamo_component_gpu_cache_usage_percent", labels={}, value=0.82),
        ],
        scrape_time_ms=9.5,
    )
